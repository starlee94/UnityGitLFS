...
public class BattleSystem : MonoBehaviour
{
    ...
    IEnumerator RunMove(BattleUnit sourceUnit, BattleUnit targetUnit, Move move)
    {
        ...
        yield return dialogBox.TypeDialog($"{sourceUnit.Pokemon.Base.Name} use {move.Base.Name}!");
    ...
    IEnumerator RunMoveEffects(Move move, Pokemon source, Pokemon target)
    {
        ...
        {
            if (move.Base.Target == MoveTarget.Self) source.ApplyBoost(effects.Boosts);
            else target.ApplyBoost(effects.Boosts);
        }
    ...
    void ActionSelection()
    {
        ...
        dialogBox.SetDialog($"What will {playerUnit.Pokemon.Base.Name} do?");
    ...
    {
        if (playerUnit.Pokemon.Speed >= enemyUnit.Pokemon.Speed)ActionSelection();
        else EnemyMove();
    }
    ...
    void HandlePartySelection()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Z))
        {
            ...
            {
                partyScreen.SetMessageText("Pokemon Fainted!");
                return;
            }
            if(selectedMember == playerUnit.Pokemon)
            {
                partyScreen.SetMessageText("This is the current pokemon.");
                return;
            }
    ...
    IEnumerator SwitchPokemon(Pokemon newPokemon)
    {
        ...
        if (currentPokemonFainted) ChooseFirstTurn();
